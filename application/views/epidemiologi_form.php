    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2">
        ...
        <div class="container text-left">
          <h5><i class="fas fa-user mr-2"></i>Identitas Kasus</h5><hr>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>ID Kasus</label>
                <input type="text" disabled name="id_kasus" class="form-control" value="<?= $this->Ternary->isset_value($epidemiologi['id_kasus'], 'otomatis')?>" required>
              </div>
              <div class="form-group">
                <label>NIK</label>
          ...
          <div class="col-md-6">              
            ...
            <div class="form-group">
              <label>Dilakukan Pelacakan Kontak Erat</label>
              <select name="pelacakan_kontak_erat" class="form-control">
                <?php foreach ($this->TracingConstant->ya_tidak() as $key => $value) { ?>
                  <option value="<?=$key?>" <?= $this->Ternary->istrue_value($epidemiologi['pelacakan_kontak_erat'] ==  $key, 'selected')?> > <?=$value?> </option>
                <?php } ?>
              </select> 
            </div>
