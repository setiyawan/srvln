    ...
    <div class="row no-gutters mt-5">
      ...
      <div class="col-md-10 p-5 pt-2">
        <h5><i class="fas fa-user mr-2"></i>KONTAK ERAT</h5><hr>
          ...
          <a href="<?=base_url()?>kontakerat/tambah" class=" btn btn-primary mb-3"><i class="fas fa-plus-circle mr-3"></i>TAMBAH KONTAK ERAT</a>
          <table class="table table-hover table-striped table-bordered">
            <thead>
              <tr>
                <th scope="col">#</th>
                <th scope="col">ID Kontak Erat</th>
                <th scope="col">Nama</th>
                <th scope="col">Umur</th>
                <th scope="col">Jenis Kelamin</th>
                <th scope="col">Status</th>
                <th scope="col">Hasil Pemantauan</th>
            ...
            <tbody>
              ...
              <tr>
                <th scope="row"> <?= $row++; ?></th>
                <td> <?= $value['id_kontak_erat']?> </td>
                <td> <?= $value['nama'] ?> </td>
                <td> <?= $value['umur'] ?> </td>
                <td> <?= $value['jenis_kelamin'] ?> </td>
                <td> <?= $value['status_pasien'] ?> </td>
                <td> <?= $value['hasil_pemantauan'] ?> </td>
                <td> <?= $value['id_upk'] ?> </td>
                ...
                <td>
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                      <a class="dropdown-item" href="<?= base_url()?>kontakerat/edit?id=<?= $value['id_personal']?>">Edit Profil</a>
                      <a class="dropdown-item" href="<?= base_url()?>kontakerat/edit?id=<?= $value['id_personal']?>">Update Pemantauan</a>
